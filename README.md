...
git clone https://github.com/[usuario]/mundial2026.git
cd mundial2026

# Ejecutar marcadores Poisson (Agente-07)
cd mundial2026
...
> **Nota:** Los resultados de las simulaciones ya estan incluidos en `/outputs/`. No es necesario re-ejecutar las 10,300,000 simulaciones para ver los resultados — el frontend los carga directamente desde `data.ts`.
